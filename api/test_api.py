...
class TestIntegration(TestCase):
    ...
    def test_feedback(self):
        ...
        data = {
            "report": "{'filename': 'test', 'prediction': 'test-pred', 'score': 1.0 }"
        }
        response = self.client.post(
            "/feedback",
            data=data,
...
class TestEnpointsAvailability(TestCase):
    ...
    def test_feedback(self):
        ...
        self.assertEqual(response.status_code, 200)
        print("Feedback Availability OK")
    ...
    def test_predict(self):
        ...
        # Bad args
        self.assertEqual(response.status_code, 400)
        print("Predict Availability OK")

if __name__ == "__main__":
  # test = TestEnpointsAvailability()
  # test.setUp()
  # test.test_index()
  # test.test_predict()
  # test.test_feedback()
  ...
  test.setUp()
  test.test_predict_ok()
  # test.test_predict_bad_parameters()
  # test.test_feedback()